<template>
  <div class="app-container base-page">
    <div class="inline pl24">
      <div class="left">
        <p><span class="color-blue">丨</span><span><b>沟通记录列表</b></span></p>
      </div>
          ...
          <ul v-for="(item, index) in doctorGroupList" :key="index">
            <li>
              <div>
                ...
                <i class="node-icon"></i>
                <span class="txt">{{item.record}}</span>
              </div>
              <div class="flex">
            ...
            <!-- <li>
                ...
                <i class="node-icon"></i>
                <span class="txt">医生，专研学习医学科学技术，挽救生命以治病为业的人，一般指临床医生。按照卫生部、卫健委、医政部有关医疗卫生管理条例的法律法规。</span>
              </li>
              <li>
                <span class="time">2016-03-10 18:07:15</span>
                <i class="node-icon"></i>
...
export default {
  ...
  methods: {
    getDoctorGroupList () {
      ...
      this.$_http
        .get(this.$_API.INTERFACE_TMC_GET_PATIENT_CONTACT_LIST, { params })
        .then(response => {
