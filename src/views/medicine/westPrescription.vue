  ...
  <div>
    ...
    <div class="detail-row">
      <div class="row2-item">
        ...
        <div class="row2-border">{{patientInfo.liver}}</div>
      </div>
      <div class="row2-item">
        <span class="detail-label">肾功能：</span>
        <div class="row2-border">{{patientInfo.renal}}</div>
      </div>
    </div>
    <div class="detail-row">
      <div class="row2-item">
      ...
      <div class="row2-item" v-if="patientInfo.sex === 2">
    ...
    <div class="medicine-container">
      ...
      <div v-for="(item, index) in medicines" :key="index" class="medicine-item">
        <div class="medicine-item_row1">
          <span @click="openDrugDescription(item)" style="color: rgb(64, 158, 255);cursor: pointer">{{item.medicineName}}</span>
