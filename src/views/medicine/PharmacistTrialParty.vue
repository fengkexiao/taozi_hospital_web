<template>
  <div class="app-container base-page">
    ...
    <el-table :data="tableData" stripe class="mt24" :loading="tableLoading">
      ...
      <el-table-column prop="rpTime" label="开方时间" align="center"></el-table-column>
      ...
      <el-table-column prop="9" label="操作" align="center">
        <template #default="{row}">
          <div class="option-btn_group">
            ...
            <span v-else class="opt-text" @click="details(row)">详情</span>
          </div>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    trialParty (row) {
      this.$router.push({
        ...
        params: { rpID: row.keyID, sign: "1", route: "pharmacistTrialParty" }
      });
    },
    // 点击详情操作
    details (row) {
      this.$router.push({
        name: "trialPartyAndDetails",
        params: { rpID: row.keyID, sign: "2", route: "pharmacistTrialParty" }
      });
    }
  }
};
