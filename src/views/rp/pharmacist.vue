  ...
  <div class="app-container base-page">
    ...
    <div class="base-search_form">
      <div class="form-item">
        ...
        <el-select v-model="query.rpTypeID" placeholder="请选择" filterable clearable>
      ...
      <div class="form-item">
        ...
        <el-input v-model="query.rpID" filterable clearable placeholder="请输入"></el-input>
      </div>
      <div class="form-item">
        <span class="item-label">患者：</span>
        <el-input v-model="query.patientName" clearable placeholder="请输入"></el-input>
      </div>
      <div class="form-item">
        <span class="item-label">医生：</span>
        <el-input v-model="query.doctorName" clearable placeholder="请输入"></el-input>
      </div>
      <div class="form-item">
      ...
      <el-table-column label="操作" width="150" align="center">
        <template #default="{row}">
          <div class="option-btn_group">
            <span class="opt-text" @click="trialParty(row, '1')">详情</span>
            <div class="line" v-if="row.rpStatus === 1"></div>
            <span class="opt-text" v-if="row.rpStatus === 1" @click="trialParty(row, '2')">审方</span>
          </div>
        </template>
      </el-table-column>
    </el-table>
