<template>
  <div class="video-dialog" id="video-dialogPopUp" v-if="videoVisible">
...
export default {
  ...
  methods: {
    ...
    // 视频云端混流
    videoMix() {
      if(JSON.stringify(this.videoMultiTalk) === "{}") {
        return false
      }
      let params = {
        userStreamID: this.videoMultiTalk.patientStreamID,
        doctorStreamID: this.videoMultiTalk.doctorStreamID
      };
