<template>
  <div class="app-container base-page">
    ...
    <base-title name="护士列表"></base-title>
    ...
    <popup-add-by-vertify :visible.sync="dialogVisible" :popHandling="popHandling" :sections="sections" title="创建护士" @save="save" />
    <el-dialog class="popup-vertify" title="修改护士" :visible.sync="updateDoctor" width="470px">
